...
public class HomeController {
    ...
    //         Cart cart = (Cart) user.getCarts(); // Assuming getCarts returns a Cart object
    //         session.setAttribute("totalsItems", cart.getTotalsItem()); // Assuming getTotalItems returns total items
    //     } else {
